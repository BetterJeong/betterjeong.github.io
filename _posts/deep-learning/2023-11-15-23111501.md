...
\begin{pmatrix}
{\delta {L} \over {\delta {x_1}}}, {\delta {L} \over \delta {x_2}}, 
\cdots, {\delta {L} \over \delta {x_n}}
\end{pmatrix}
$$  
...
$$
{\delta {L} \over \delta {W}} = 
\begin{pmatrix}
{\delta {L} \over \delta {W_{11}}} && \cdots && {\delta {L} \over \delta {W_{1n}}} \\ \vdots && \ddots \\
{\delta {L} \over \delta {W_{m1}}} && && {\delta {L} \over \delta {W_{mn}}}
\end{pmatrix}
$$
...
{\delta {z} \over {\delta {y}}} {\delta {y} \over {\delta {x}}}
$$
